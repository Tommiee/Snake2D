...
function create ()
{
    ...
    var Snake = new Phaser.Class({
        ...
        move: function (time)
        {
            ...
            */
            ...
            {
                case LEFT:
                    this.headPosition.x = Phaser.Math.Wrap(this.headPosition.x - 1, 0, cols);
                    break;
                ...
                case UP:
                    this.headPosition.y = Phaser.Math.Wrap(this.headPosition.y - 1, 0, rows);
                    break;
    ...
    food = new Food(this, 5, 8);

    snake = new Snake(this, 13, 28);
...
function repositionFood ()
{
    ...
    var testGrid = [];
    testGrid = make2DArray(cols,rows);
